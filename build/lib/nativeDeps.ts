...
// Packaging filters for multi-architecture native dependencies.
//
// These two filters used to live in `build/lib/copilot.ts` next to the
// @github/copilot packaging helpers. They have nothing to do with Copilot --
// they strip wrong-architecture payloads from @vscode/ripgrep-universal and
// @microsoft/mxc-sdk -- so they were moved here when Copilot was removed from
// the product.
